...
const AboutSection = () => {
  ...
  return (
    <div 
      className='w-full h-screen bg-linear-to-r from-blue-50 to-pink-50'
      style={{
    ...
    >
      <div className='w-full relative h-screen'>
        <div className='absolute top-0 left-0 w-1/2 h-screen bg-white z-1 py-4 pl-10'>
          <h2 className='text-center text-3xl font-semibold text-[#336EAA] mt-10'>About Us</h2>
          ...
          <Link to="about-us" className='text-lg font-semibold p-3 px-8 border rounded-lg shadow-md shadow-[#326EAC] text-[#326EAC] hover:bg-[#326EAC] hover:text-white transition-all duration-300 cursor-pointer'>Read more</Link>
        </div>
        <div className='absolute top-50 right-25 w-60 h-45 border-6 rounded-2xl border-white shadow-2xl'></div>
        <div className='absolute bottom-70 right-75 w-60 h-45 border-6 border-r-0 rounded-2xl border-[#326EAC]'></div>
        <img src="https://res.cloudinary.com/dxvovx7s2/image/upload/v1765975719/Screenshot_2025-12-17_181706_mmd8dk.png" alt="about image-1" className='absolute top-20 right-75 w-90 h-65 border border-white rounded-md shadow-2xl z-1'/>
        <img src="https://res.cloudinary.com/dxvovx7s2/image/upload/v1765975719/Screenshot_2025-12-17_181807_rnxh9h.png" alt="about image-1" className='absolute bottom-32 right-5 w-90 h-55 border border-white rounded-md shadow-2xl z-1'/>
